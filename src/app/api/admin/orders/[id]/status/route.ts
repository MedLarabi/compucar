        ...
        try {
          ...
          if (autoCreateEnabled) {
            ...
            const yalidinePayload = {
              ...
              price: existingOrder.yalidine.price, // Price already contains only product total (shipping excluded during order creation)
              ...
              freeshipping: true, // Price already includes our calculated shipping - don't add Yalidine shipping
